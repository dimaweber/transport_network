...
int main(int argc, char** argv) {
    ...
    // Define CLI options
    app.add_option("-i,--input", input_file, "Input DOT file path")
       ->check(CLI::ExistingFile);
    app.add_option("-o,--output", output_file, "Output DOT file path");
    app.add_option("-l,--log-level", log_level, "Logging level (debug, info, warn, error)")
    ...
    spdlog::info("Successfully parsed network with {} cities and {} roads",
                parser.get_network().get_city_count(),
                parser.get_network().get_road_count());
